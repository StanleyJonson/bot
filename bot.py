...
predictions = [
    ...
    "Ближайший месяц в этом чате ты будешь ощущать себя, как тефтелька в тарелке борща. Тебе тут явно не место, но в целом сойдёт.",
    "Давние мечты осуществятся, смелые планы реализуются! Но не у тебя",
    "Закажешь чего-нибудь поесть. Тебе плюнут в еду."
]
